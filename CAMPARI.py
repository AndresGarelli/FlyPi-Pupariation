...
#        self.emptyLabel.grid(row=1, column=1, sticky="s")        
        ...
        self.PWMLED1.start(100)
        self.PWMLED2.start(100)
        self.PWMLED4.start(100)
        #self.PWMLED5.start(100)
#
        ...
        self.LED3STOPbutton = tk.Checkbutton(master=frame2,
                                  text="STOP", fg="gray",variable=self.stop3, indicatoron=False)
        ...
        self.LED6STOPbutton = tk.Checkbutton(master=frame2,
                                  text="STOP", fg="gray",variable=self.stop6, indicatoron=False)
...
#Functions for LED1    
    def LED1start(self):
        ...
        while cycle < valRepeat and stop==False:
            intensidad=100-self.ScaleLEDs.get()
            print(intensidad)
